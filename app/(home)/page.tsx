  ...
  return (
    <main className="py-20">
      <div className="prose lg:prose-xl max-w-4xl mx-auto px-4">
        ...
        <p><strong>글 쓰는 개발자 모임, 글또</strong>의 페이지에 오신 것을 환영합니다</p>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 my-4">
          <p className="font-bold">글또 추후 기수 공지</p>
          <ul>
            <li>글또는 10기까지 운영될 예정입니다(25년 3월까지 10기 운영)</li>
            <li>추가 모집을 받고 있지 않고 있습니다</li>
          </ul>
        </div>

        <h2>글또 커뮤니티의 비전</h2>
        <ul>
          <li><strong>글을 작성하는 개발 직군분들이 모여서, 좋은 영향을 주고 서로 같이 자랄 수 있는 커뮤니티</strong></li>
          <li>개발자들의 성장을 지원하는 커뮤니티</li>
          <li>각자의 직군에서 얻을 수 있는 내용을 토대로 글쓰기 진행
            <ul>
        ...
        <ul className="list-none">
          ...
          <li className="mb-6">
            ...
            <ul>
              ...
              <li><a href="https://github.com/geultto/Village-Neighborhood-Meeting">빌리지 반상회 발표 자료</a></li>
              <li><a href="https://github.com/geultto/geultto-curation">큐레이션 모음</a></li>
            </ul>
          </li>
          ...
          <li className="mb-6">
            ...
            <ul>
              ...
              <li>글또 내부 컨퍼런스 (글또콘)
                <ul>
                  <li><a href="https://github.com/geultto/geultto-conference">글또콘 발표 자료</a></li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li className="mb-6">
            ...
            <ul>
              ...
              <li><a href="https://github.com/geultto/geultto-contents/issues/1">회고 모음집 Github 생성</a></li>
            </ul>
          </li>
          ...
          <li className="mb-6">
            ...
            <ul>
              ...
              <li><a href="https://zzsza.github.io/diary/2019/10/20/helping-presentation/">발표 컨설팅 관련 글</a></li>
            </ul>
          </li>
          ...
          <li className="mb-6">
            ...
            <ul>
              <li><a href="https://www.slideshare.net/zzsza/ss-137831892">Write the Docs Seoul : 글쓰는 개발자 모임, 글또 발표</a></li>
            </ul>
          </li>
        ...
        <h2>글또를 만들게 된 계기</h2>
        <ul>
          <li>2017년 12월, 개발 블로그를 시작하고 주변 지인들과 이야기를 나눴습니다. 지인들 모두 개발 블로그를 만들었거나 하고 싶은 의지가 있었어요</li>
          <li>그러나, 그 의지를 꾸준히 유지하는게 매우 힘들었어요. 꾸준히 글을 작성하는 동기를 주지 못한 것이 큰 이유였다고 하네요</li>
          <li>주변 지인분들을 돕기 위해 + 빡세게 관리하기 위해 예치금을 건 글또를 만들었습니다. 예치금을 건 이유는 저도 마음 고생하지 않고, 작성하지 않은 경우 글을 차감하고 끝(닦달하지 않고)</li>
          <li>2기, 3기를 하며 많은 분들의 이야기를 듣고, 글또 분들이 성장할 수 있는 커뮤니티로 확장하려고 합니다. 발표 지원, 모각글 등을 할 예정이에요</li>
          <li>글 쓰는 개발자 모임이 많이 생기면 좋겠습니다. 꼭 글또가 아니여도, 주변 지인들을 모아 할 수 있도록 저희의 시스템을 모두 공유합니다. 다만 글또를 참고했다 정도로 작성해주시면 좋을 것 같아요 :)</li>
